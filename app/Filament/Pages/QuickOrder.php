                            ...
                            ->schema([
                                ...
                                Placeholder::make('remove_btn')
                                    ...
                                    ->content(new \Illuminate\Support\HtmlString(
                                        ...
                                        . '<button type="button" x-on:click="$wire.mountAction(\'delete\', { item: $el.closest(\'li[x-sortable-item]\').getAttribute(\'x-sortable-item\') }, { schemaComponent: \'form.items\' })" style="background:none;border:none;cursor:pointer;color:#6b4c3b;transition:color 0.15s;" onmouseover="this.style.color=\'#c0392b\'" onmouseout="this.style.color=\'#6b4c3b\'">'
