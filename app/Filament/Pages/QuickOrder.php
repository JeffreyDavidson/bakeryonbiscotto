                            ...
                            ->schema([
                                ...
                                Placeholder::make('remove_btn')
                                    ...
                                    ->content(new \Illuminate\Support\HtmlString(
                                        ...
                                        . '<button type="button" x-on:click="$wire.mountAction(\'delete\', { item: $el.closest(\'li[x-sortable-item]\').getAttribute(\'x-sortable-item\') }, { schemaComponent: \'form.items\' })" style="background:none;border:none;cursor:pointer;color:#c4a882;transition:color 0.15s;" onmouseover="this.style.color=\'#c0392b\'" onmouseout="this.style.color=\'#c4a882\'">'
