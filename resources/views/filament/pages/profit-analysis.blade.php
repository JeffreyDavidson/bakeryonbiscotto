<x-filament-panels::page>
    <style>
        ...
        .profit-filters { display: flex; flex-wrap: wrap; gap: 1rem; align-items: end; margin-bottom: 1.5rem; padding: 1rem; background: #fff; border: 1px solid var(--brand-200); border-radius: 12px; }
        .profit-filters label { font-size: 0.75rem; font-weight: 600; color: var(--brand-700); display: block; margin-bottom: 0.25rem; }
        .profit-filters select, .profit-filters input { border: 1px solid var(--brand-200); border-radius: 8px; padding: 0.45rem 0.75rem; font-size: 0.85rem; background: var(--brand-50); color: var(--brand-900); }
        .profit-table-wrap { background: #fff; border: 1px solid var(--brand-200); border-radius: 12px; overflow-x: auto; }
        .profit-table { width: 100%; border-collapse: collapse; font-size: 0.85rem; }
        .profit-table th { background: var(--brand-900); color: var(--brand-50); padding: 0.75rem 1rem; text-align: left; font-weight: 600; cursor: pointer; user-select: none; white-space: nowrap; }
        .profit-table th:hover { background: var(--brand-700); }
        .profit-table td { padding: 0.6rem 1rem; border-bottom: 1px solid #f0e6d8; color: var(--brand-900); }
        .profit-table tr:hover td { background: var(--brand-50); }
        ...
        .margin-red { background: #fee2e2; color: var(--status-danger-dark); }
        ...
        <div class="profit-table-wrap">
            <table class="profit-table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="9" style="text-align:center;padding:2rem;color:var(--brand-700);">No products found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
